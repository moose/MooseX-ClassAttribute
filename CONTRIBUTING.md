...
If you use cpanminus, you can do it without downloading the tarball first:
    ...
    $ cpanm --reinstall --installdeps --with-recommends MooseX::ClassAttribute
...
You can also do this via cpanm directly:
    ...
    $ cpanm --reinstall --installdeps --with-develop --with-recommends MooseX::ClassAttribute
...
The code for this distribution is [hosted at GitHub](https://github.com/moose/MooseX-ClassAttribute).
...
can submit an issue report [via the web](http://rt.cpan.org/Public/Dist/Display.html?Name=MooseX-ClassAttribute)
or [via email](bug-moosex-classattribute@rt.cpan.org.
